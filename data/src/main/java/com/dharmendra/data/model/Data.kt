...
data class Data(
    ...
    @SerializedName("images") var images: Images2? = Images2(),
    @SerializedName("trailer") var trailer: Trailer? = Trailer(),
    @SerializedName("approved") var approved: Boolean = false,
    ...
    @SerializedName("airing") var airing: Boolean = false,
    ...
    @SerializedName("producers") var producers: ArrayList<Producers> = arrayListOf<Producers>(),
    @SerializedName("licensors") var licensors: ArrayList<Licensors> = arrayListOf<Licensors>(),
    @SerializedName("studios") var studios: ArrayList<Studios> = arrayListOf<Studios>(),
    @SerializedName("genres") var genres: ArrayList<Genres> = arrayListOf<Genres>(),
    ...
    @SerializedName("demographics") var demographics: ArrayList<Demographics> = arrayListOf<Demographics>()
)